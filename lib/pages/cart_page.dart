...
class _CartPageState extends State<CartPage> {
  ...
  void decrementQuantity(BuildContext context, Menus menu) {
    ...
    if (currentItem.quantity == 0) {
      showDeleteConfirmationDialog(context, menu);
      ...
      builder: (context) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: Column(
            children: [
              const SizedBox(height: 8),
              Icon(Icons.shopping_cart, color: primaryColor, size: 60),
              const SizedBox(height: 8),
              const Text(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    //PRICE
                                    Text(
                                      formatPrice(cartItem.menu.price *
                                          cartItem.quantity),
              ...
              builder: (context, state) {
                ...
                return Column(
                  children: [
                    ...
                    //ORDER NOW BUTTON
                    GestureDetector(
                      onTap: () => showOrderConfirmationDialog(context),
                      child: Container(
                        decoration: BoxDecoration(
                            color: primaryColor,
                            borderRadius: BorderRadius.circular(40)),
